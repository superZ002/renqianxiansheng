document.addEventListener('DOMContentLoaded', function() {
    ...
    function initShare() {
        shareBtn.addEventListener('click', function() {
            ...
            var text = parts.join('\n');
            if (navigator.share) {
                navigator.share({ title: '人前显圣', text: text }).catch(function() {});
    ...
    function initVisitCounter() {
        var count = parseInt(localStorage.getItem('xiansheng_count') || '2847', 10);
    ...
    function incrementVisitCounter() {
        var count = parseInt(localStorage.getItem('xiansheng_count') || '2847', 10);
        count++;
        localStorage.setItem('xiansheng_count', String(count));
        visitCountEl.textContent = count;
    }
});